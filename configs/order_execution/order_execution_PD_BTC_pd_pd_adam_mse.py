...
data = dict(
    ...
    test_dynamic_path="data/order_execution/PD_BTC/Market_Dynamics_Model/BTC/test_labeled_slice_and_merge_model_3dynamics_minlength12_quantile_labeling.csv",
    tech_indicator_list=[
        "high",
        "low",
        "open",

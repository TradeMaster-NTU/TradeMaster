...
path = "./tools/CSDI_Toolbox/data/" + args.dataset + "/" + args.tic + "_missing" + str(args.testmissingratio) + "_seed1.pk"
path2 = "./tools/CSDI_Toolbox/save/" + args.dataset + "/" + args.tic + "_" + str(args.testmissingratio) + "/generated_outputs_nsample100.pk"
...
#plt.pause(2)
path3 = "./tools/CSDI_Toolbox/visual/" + args.dataset + "/" + args.tic + str(args.testmissingratio)
os.makedirs(path3, exist_ok=True)
plt.savefig(path3 + "/point_chart" + str(args.dataind) + ".png")
plt.show()
plt.close()
...
path4 = path3 + "/candlestick_chart" + str(args.dataind) + ".png"
